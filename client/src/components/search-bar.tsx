...
const SearchBar=({onchange,name}:HandleChage)=>{
  return (
   ...
   {/* <AiOutlineSearch className="w-10 text-[20px] font-[900] "/>*/}
    <input className="input py-2  text-[16px]  flex-auto focus:outline-0" type="text" placeholder="Search by name" name={name} onChange={onchange}/>
    </div>
    )
}
