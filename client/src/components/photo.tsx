...
const Photo = ({ photoObjects, deletehandler }: photo) => {
  ...
  return (
    <div className="photo-container inline " onClick={showOverlayHandler}>
      <div>
        {showDeleteModal && (
          <Modal
            modalContentent={
              <div className="bg-[#fff] flex flex-col w-full p-4 rounded-[10px] mb-[9rem] mx-auto  md:w-[320px] ">
                <h3 className="text-[18px] font-[500]">Are your sure ? </h3>
                <label className="my-2">
                  Password : Type{" "}
                  <span className="font-[600]">{photoObjects.label}</span> to
                  confirm delete
                </label>
                ...
                <div className="mt-4 flex ">
                  <div className="flex justify-end w-full space-x-4">
                    <Btn
                      text="Cancel"
                      onclickHandler={hideDeletemodalHandler}
                      bgcolor="#fff"
                      loading={false}
                      disabled={false}
                      color="black"
        ...
        <img
          className="photo rounded-[10px]"
          src={photoObjects.filepath}
          alt="alt"
        />
        {showOverlay && (
          <div>
            ...
            <div className="delete-btn">
              <Btn
                text="Delete"
                onclickHandler={showDeleteModalHadler}
                bgcolor="transparent"
                color="#fff"
                loading={false}
                disabled={false}
